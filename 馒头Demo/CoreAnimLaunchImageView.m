...
const CGFloat ShowTimeDuration = 1.0f;
...
-(void)dismiss{
    ...
    //添加一个转场动画
    [self.superview.layer transitionWithAnimType:TransitionAnimTypeRippleEffect subType:TransitionSubtypesFromBotoom curve:TransitionCurveEaseOut duration:3.0f];
